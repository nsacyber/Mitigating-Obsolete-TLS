...
#   and setting Cipher Suite for CNSA
...
$CipherValue = ('TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384','TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384',
    'TLS_DHE_RSA_WITH_AES_256_GCM_SHA384','TLS_RSA_WITH_AES_256_GCM_SHA384')
$EccCurvesValue = ('secP384r1')

# Cipher 'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384' does not seem supported by Microsoft Windows
